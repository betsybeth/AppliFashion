...
fixture `Task 2 Shopping Experience Test`
    ...
    test("Heart icon is  displayed on hover", async testController => {
        await testController.hover(crossElementTests.blackShoeImageSelector)
        const isVisible = await crossElementTests.heartIconSelector.visible
        await testController.expect(hackathonReporter(2, "Heart icon is  displayed on hover", "I__tiheart__225",
