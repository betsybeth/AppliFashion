...
fixture `Task 3 Product Details Tests`
    ...
    test("Navigate to individual product details ", async testController => {
        const browserAlias = testController.browser.alias
        const isVisible = crossElementTests.blackProductDetailsPageSelector.visible
        await testController.expect(hackathonReporter(3, "Navigate to individual product details ", "#page",
        testController.browser.name, browserAlias, isVisible )).ok()
    })
